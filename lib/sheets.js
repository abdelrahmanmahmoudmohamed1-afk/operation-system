...
const SOURCES = {
  ...
  leads: [{ project:'', id:process.env.GOOGLE_LEADS_SPREADSHEET_ID || process.env.GOOGLE_LEADS_SHEET || '1WvVUpsAGUlIxV3ZUmEx-3DbX0UGCK4cIxai7Em9PZxU', sheet:process.env.GOOGLE_LEADS_TAB_NAME || 'Feedback Leads', headerRow:1 }]
};
