...
const SOURCES = {
  ...
  eoi: [{ project:'Mersea', id:process.env.GOOGLE_EOI_SPREADSHEET_ID || process.env.GOOGLE_EOI_SHEETS || process.env.GOOGLE_EOI_SHEET || '1k0N-63K7tpinWHmODki7eLKXnH8k9wWetBUgKPgLOwg', sheet:process.env.GOOGLE_EOI_TAB_NAME || 'EOI Data', sheetAliases:['EOI Data','EOIS MERSEA',"EOI's",'EOI'], headerRow:1 }],
