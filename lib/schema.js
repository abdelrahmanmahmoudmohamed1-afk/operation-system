...
function connectionConfig(){
  ...
  if(connectionString) return {connectionString,ssl:{rejectUnauthorized:false},max:2,idleTimeoutMillis:10000,connectionTimeoutMillis:10000};
...
export async function tableCounts(){
  ...
  const names=['profiles','inventory_units','clients','eoi_records','leads','documents','audit_logs','reminders'];
  const out={};
