...
async function handle(action,payload){
  ...
  switch(action){
    ...
    case 'updateSystemUser':{
      ...
      await audit(adminUser,'update_user_role','users',{targetUser:current.username,oldRole:current.role,newRole:role,oldActive:current.is_active,newActive:active});return{...data,name:data.full_name,active:data.is_active};
    }
