const PERMISSIONS = Object.freeze({
    ...
    ceo: ["overview", "dashboard", "inventory", "payment", "crm", "eoi", "reports", "contracts", "settings"],
    operation: ["overview", "dashboard", "inventory", "payment", "crm", "eoi", "reports", "contracts", "settings"],
    operations: ["overview", "dashboard", "inventory", "payment", "crm", "eoi", "reports", "contracts", "settings"],
