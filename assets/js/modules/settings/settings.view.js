...
export function renderLayout(user, currentTheme, prefs = {}, history = []) {
    ...
    return `
        ...
        <div class="settings-command-center">
            ...
            <div class="settings-mini-card"><span>Language</span><strong>${escapeHtml((prefs.language || localStorage.getItem("operation_system_language") || "en").toUpperCase())}</strong></div>
